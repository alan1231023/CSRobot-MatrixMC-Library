...
********************************************************************************
    ...
    File info:
        ...
        Created By:   
        Modified:     2025/2/2 下午 10:38:58
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: MatrixMCArduino
        Product ID:   
...
#define OD_CNT_ARR_6001 4
#define OD_CNT_ARR_6002 4
#define OD_CNT_ARR_6003 4
#define OD_CNT_ARR_6004 4
#define OD_CNT_ARR_7001 2
#define OD_CNT_ARR_7002 2
#define OD_CNT_ARR_7003 2
#define OD_CNT_ARR_7004 2
#define OD_CNT_ARR_8001 4
#define OD_CNT_ARR_8002 4
#define OD_CNT_ARR_8003 4
#define OD_CNT_ARR_8004 4
...
typedef struct {
    ...
    uint8_t x6001_dev1_ENCArr_sub0;
    int32_t x6001_dev1_ENCArr[OD_CNT_ARR_6001];
    uint8_t x6002_dev2_ENCArr_sub0;
    int32_t x6002_dev2_ENCArr[OD_CNT_ARR_6002];
    uint8_t x6003_dev3_ENCArr_sub0;
    int32_t x6003_dev3_ENCArr[OD_CNT_ARR_6003];
    uint8_t x6004_dev4_ENCArr_sub0;
    int32_t x6004_dev4_ENCArr[OD_CNT_ARR_6004];
    uint8_t x7001_dev1_RCArr_sub0;
    uint8_t x7001_dev1_RCArr[OD_CNT_ARR_7001];
    uint8_t x7002_dev2_RCArr_sub0;
    uint8_t x7002_dev2_RCArr[OD_CNT_ARR_7002];
    uint8_t x7003_dev3_RCArr_sub0;
    uint8_t x7003_dev3_RCArr[OD_CNT_ARR_7003];
    uint8_t x7004_dev4_RCArr_sub0;
    uint8_t x7004_dev4_RCArr[OD_CNT_ARR_7004];
    uint8_t x8001_dev1_MotorSpeedArr_sub0;
    int8_t x8001_dev1_MotorSpeedArr[OD_CNT_ARR_8001];
    uint8_t x8002_dev2_MotorSpeedArr_sub0;
    int8_t x8002_dev2_MotorSpeedArr[OD_CNT_ARR_8002];
    uint8_t x8003_dev3_MotorSpeedArr_sub0;
    int8_t x8003_dev3_MotorSpeedArr[OD_CNT_ARR_8003];
    uint8_t x8004_dev4_MotorSpeedArr_sub0;
    int8_t x8004_dev4_MotorSpeedArr[OD_CNT_ARR_8004];
    uint8_t x9001_dev1_HeartbeatValue;
    uint8_t x9002_dev2_HeartbeatValue;
    uint8_t x9003_dev3_HeartbeatValue;
    uint8_t x9004_dev4_HeartbeatValue;
} OD_PERSIST_COMM_t;
...
#define OD_ENTRY_H6001 &OD->list[41]
#define OD_ENTRY_H6002 &OD->list[42]
#define OD_ENTRY_H6003 &OD->list[43]
#define OD_ENTRY_H6004 &OD->list[44]
#define OD_ENTRY_H7001 &OD->list[45]
#define OD_ENTRY_H7002 &OD->list[46]
#define OD_ENTRY_H7003 &OD->list[47]
#define OD_ENTRY_H7004 &OD->list[48]
#define OD_ENTRY_H8001 &OD->list[49]
#define OD_ENTRY_H8002 &OD->list[50]
#define OD_ENTRY_H8003 &OD->list[51]
#define OD_ENTRY_H8004 &OD->list[52]
#define OD_ENTRY_H9001 &OD->list[53]
#define OD_ENTRY_H9002 &OD->list[54]
#define OD_ENTRY_H9003 &OD->list[55]
#define OD_ENTRY_H9004 &OD->list[56]
...
#define OD_ENTRY_H6001_dev1_ENCArr &OD->list[41]
#define OD_ENTRY_H6002_dev2_ENCArr &OD->list[42]
#define OD_ENTRY_H6003_dev3_ENCArr &OD->list[43]
#define OD_ENTRY_H6004_dev4_ENCArr &OD->list[44]
#define OD_ENTRY_H7001_dev1_RCArr &OD->list[45]
#define OD_ENTRY_H7002_dev2_RCArr &OD->list[46]
#define OD_ENTRY_H7003_dev3_RCArr &OD->list[47]
#define OD_ENTRY_H7004_dev4_RCArr &OD->list[48]
#define OD_ENTRY_H8001_dev1_MotorSpeedArr &OD->list[49]
#define OD_ENTRY_H8002_dev2_MotorSpeedArr &OD->list[50]
#define OD_ENTRY_H8003_dev3_MotorSpeedArr &OD->list[51]
#define OD_ENTRY_H8004_dev4_MotorSpeedArr &OD->list[52]
#define OD_ENTRY_H9001_dev1_HeartbeatValue &OD->list[53]
#define OD_ENTRY_H9002_dev2_HeartbeatValue &OD->list[54]
#define OD_ENTRY_H9003_dev3_HeartbeatValue &OD->list[55]
#define OD_ENTRY_H9004_dev4_HeartbeatValue &OD->list[56]
